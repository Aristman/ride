...
**Доступные команды:**
• `/plan <задача>` - создать детальный план и выполнить задачу по шагам
...
• `/plan Оптимизировать производительность приложения`
• `/plan Добавить тестирование для модуля авторизации`
