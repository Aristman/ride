...
@Serializable
private data class HFMessage(
    val role: String,
    val content: String
)

@Serializable
private data class HFChatCompletionsRequest(
    val model: String,
...
@Serializable
private data class HFChatCompletionsResponse(
    val id: String? = null,
...
@Serializable
private data class HFChoiceMessage(
