...
class A2AArchitectureToolAgent(
    ...
    a2aAgentId = "a2a-architecture-${System.identityHashCode(legacy)}",
    ...
    override suspend fun handleRequest(
        ...
        val step = ToolPlanStep(
            id = (request.metadata["stepId"] as? String) ?: "arch-${System.currentTimeMillis()}",
            description = (data["description"] as? String) ?: "Architecture analysis",
            agentType = AgentType.ARCHITECTURE_ANALYSIS,
