...
class A2AOpenSourceFileToolAgent(
    ...
    a2aAgentId = "a2a-open-file-${System.identityHashCode(legacy)}",
    supportedMessageTypes = setOf("OPEN_FILE_REQUEST"),
    ...
    override suspend fun handleRequest(
        ...
        if (request.messageType != "OPEN_FILE_REQUEST") {
        ...
        val step = ToolPlanStep(
            id = (request.metadata["stepId"] as? String) ?: "open-file-${System.currentTimeMillis()}",
            description = (data["description"] as? String) ?: "Open source file",
            agentType = AgentType.FILE_OPERATIONS,
