...
class ArchitectureToolAgentTest {
    ...
    private val agent = ArchitectureToolAgent()
    ...
    fun `should detect packages`() = runTest {
        val file1 = createTestFile("Service.kt", """
            package com.example.service
            
            class UserService
        """.trimIndent())
        
        val file2 = createTestFile("Model.kt", """
    ...
    fun `should detect layers`() = runTest {
        val file1 = createTestFile("UI.kt", """
            package com.example.ui
            
            class MainActivity
        """.trimIndent())
        
        val file2 = createTestFile("Service.kt", """
            package com.example.service
            
            class UserService
        """.trimIndent())
        
        val file3 = createTestFile("Model.kt", """
            package com.example.model
        ...
        val step = ToolPlanStep(
            ...
            agentType = AgentType.ARCHITECTURE_ANALYSIS,
            input = StepInput.of("files" to listOf(
                file1.absolutePath,
                file2.absolutePath,
                file3.absolutePath
            ))
    ...
    fun `should detect circular dependencies`() = runTest {
        val file1 = createTestFile("ClassA.kt", """
        ...
        val file2 = createTestFile("ClassB.kt", """
    ...
    fun `should detect layer violations`() = runTest {
        val file1 = createTestFile("Model.kt", """
            package com.example.model
        ...
        val file2 = createTestFile("UI.kt", """
            package com.example.ui
